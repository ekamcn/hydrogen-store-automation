...
const storeEditorFormSchema = z.object({
  ...
  VITE_SIREN_NUMBER: z.string().optional(),
  VITE_PP_LAST_UPDATED_DATE: z.string().optional(),
  VITE_BUSINESS_HOURS: z.string().optional(),
  VITE_REFUND_PERIOD: z.string().optional(),
  VITE_REFUND_PROCESSING_TIME: z.string().optional(),
  VITE_DELIVERY_PROVIDER: z.string().optional(),
  VITE_ORDER_PROCESSING_TIME: z.string().optional(),
  VITE_STANDARD_DELIVERY_TIME: z.string().optional(),
  VITE_RETURN_PERIOD: z.string().optional(),
  VITE_DELIVERY_AREAS: z.string().optional(),
  VITE_SUPPORT_HOURS: z.string().optional(),
  VITE_WITHDRAWAL_PERIOD: z.string().optional(),
  VITE_RETURN_SHIPPING_POLICY: z.string().optional(),
  VITE_SALE_ITEMS_POLICY: z.string().optional(),
  VITE_TC_LAST_UPDATED_DATE: z.string().optional(),
});
    ...
    const fetchAndPopulate = async () => {
      ...
      try {
        ...
        form.reset({
          ...
          VITE_COMPANY_CITY: d.companyCity || "",
