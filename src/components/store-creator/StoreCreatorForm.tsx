...
export default function StoreCreatorForm() {
  ...
  const [stepCompletionStatus, setStepCompletionStatus] = useState<boolean[]>([false, false, false, false, false, false]);
  const [stepValidationStatus, setStepValidationStatus] = useState<boolean[]>([false, false, false, false, false, false]);
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 1:
        return <ThemeSelection form={form} nextStep={nextStep} prevStep={prevStep} />;
      case 2:
        return <BrandCustomization form={form} nextStep={nextStep} prevStep={prevStep} />;
      case 3:
        return <LegalInformation form={form} nextStep={nextStep} prevStep={prevStep} />;
      case 4:
