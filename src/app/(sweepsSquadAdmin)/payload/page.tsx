...
import {
  buildStorePayload,
  DEFAULT_IMAGE_DATA,
} from "../socket/_components/buildStorePayload";
  ...
  const createShopifyStore = () => {
    if (socketRef.current && socketRef.current.connected) {
      ...
      socketRef.current.emit(
        ...
        storeData.imageData ?? DEFAULT_IMAGE_DATA
      );
      console.log(
        "🚀 Sent shopify:create event to server with payload:",
        storeData
      );
      addMessage(
        "client:sent",
        "🚀 Shopify store creation request sent to server",
